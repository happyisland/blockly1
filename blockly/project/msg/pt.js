var MSG = {
  ...
  posture_set_desc : "Abra o interruptor direito e ajuste a ação do robô",
  posture_ok_desc : "Posição após o nome da posição de entrada",
  ...
  title_time_adjust : "Ajuste da hora",
    ...
    /*项目  begin*/
    //保存项目
	input_rule_msg : "Impossível introduzir carateres especiais. Pode ser introduzido um máximo de %1 carateres ou %2 carateres chineses.",
    variable_inputrule_msg : "Impossível começar com um dígito. Impossível introduzir carateres especiais. Pode ser introduzido um máximo de %1 carateres ou %2 carateres chineses.",
	...
	infrared_tips:"O sensor infravermelho não está conectado ao modelo atual",
    touch_tips:"O sensor de toque não está conectado ao modelo atual",
    gyroscope_tips:"O sensor giroscópio não está conectado ao modelo atual",
    id_infinite_loop_error:"Saída do programa devido a falta de memória, volte e tente novamente",
    ...
    select_all:"Tudo",
    no_common_servo_info : "Atualmente não existe um servo do modo de roda (pode rodar 360°). Precisa de configurar um agora?",
    no_circle_servo_info : "Atualmente não existe um servo do modo de ângulo (pode dentro de um intervalo designado). Precisa de configurar um agora?",
