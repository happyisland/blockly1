...
var courseData =  {
    ...
    backgroundImg:appPath+'/course_8/images/bg.jpg',
    startStory : [
                    [
                        {
                            index:0,
    ...
    allStepPage: [
                    ...
                    [
                        ...
                        {key:'img',value:[
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/page1_1.png',
                                                style:{textAlign:'center',margin:'4%',width:'240px'}
                                            }
                                          ]
                        },
                        {key:'text',value:  [
                        ...
                        {key:'img',value:[
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/page1_2.png',
                                                style:{textAlign:'center',margin:'4%',width:'240px'}
                                            }
                                          ]
                        }
                    ...
                    [
                        ...
                        {key:'img',value:[
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/page2.png',
                                                style:{textAlign:'center',margin:'15% auto',width:'200px'}
                                            }
                                          ]
                        },
                        {key:'text',value:  [
                    ...
                    [
                        ...
                        {key:'img',value:[
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/page3.png',
                                                style:{textAlign:'center',margin:'15% auto',width:'240px'}
                                            }
                                          ]
                        }
                    ],[
                        ...
                        {key:'img',value:[
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/page4.png',
                                                style:{textAlign:'center',margin:'8%',width:'240px'}
                                            }
                                          ]
                        }
                    ],
                    [
                        ...
                        {key:'img',value:[
                                    ...
                                    replaceValue : [
                                            {
                                                src:appPath+'/course_8/images/'+curLanguage+'/desc1.png',
                                                style:{height:'197px'}
                                            }
                                    ]
                        },
    ...
    videoSrc :appPath+"/course_8/video/course_8.mp4",
    isShowTrash : true,
